import { c as ce, f, y, O as Oe, S as Sr, r as re, i as ot, p as po, a as Oi } from "./indexhtml-Crv9HnRQ.js";
import { a } from "./state-aTUQA9pO-CJ-X0rSy.js";
import { V } from "./base-panel-Djw-d72n-Bp8ldhFY.js";
...
var A = Object.defineProperty, P = Object.getOwnPropertyDescriptor, o = (e, t, n, l) => {
  for (var a2 = l > 1 ? void 0 : l ? P(t, n) : t, p = e.length - 1, r2; p >= 0; p--)
    (r2 = e[p]) && (a2 = (l ? r2(t, n, a2) : r2(a2)) || a2);
  return l && a2 && A(t, n, a2), a2;
};
...
let i = class extends V {
    ...
    return this.message === void 0 ? ce`
      ...
      y.emit("system-info-with-callback", {
        ...
        notify: false
              ...
              <span class="prefix">${r.github}</span>
              Create GitHub Issue
            </button>
  ...
  close() {
    Oe.closePanel("copilot-feedback-panel");
  }
  submit() {
    if (Sr("feedback", { github: false, type: this.type, topic: this.topic }), this.description.trim() === "") {
    ...
    y.emit("system-info-with-callback", {
      callback: (t) => re(`${ot}feedback`, { ...e, versions: t }),
      notify: false
  ...
  openGithub(e, t) {
    if (Sr("feedback", { github: true, type: this.type, topic: this.topic }), this.type === "idea") {
      window.open(`${u}${T}`);
      return;
    }
    ...
    const n = e ? e.replace(/\n/g, "%0A") : "Activate Copilot to include version info.", l = `${t.types.find((r2) => r2.value === this.type)?.ghTitle}`, a2 = t.description !== "" ? t.description : D, p = E.replace("{description}", a2).replace("{versionsInfo}", n);
